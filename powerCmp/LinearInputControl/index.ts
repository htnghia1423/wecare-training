...
export class LinearInputControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public init(
        ...
        // Creating HTML elements for the input type range and binding it to the refreshData method on change event
        ...
        // Creating a HTML label element that show the value that is set on the linear range control
        this.labelElement = document.createElement("label");
        this.labelElement.setAttribute("class", "LinearRangeLabel");
        this.labelElement.setAttribute("id", "lrclabel");

        // Retrieving the lasted value from the control and setting it to the HTML elements
        ...
        // Appending the created HTML elements to the control's HTML container element
